...
function ExtractVideo({handleOptionSelect, handleSetFileData, fillZeroes, formatTime,
  validateTime
}) {
    ...
    fetch(
      `${BASE_URL}/api/extract-video`,
      {
        ...
        body: JSON.stringify({
          ...
          extractEntireVideo: checked ? true : false
        }),
        headers: {
  ...
  return (
    <div>
        <div className='extract-video-title'>
        ...
        <div className='extract-video-body'>
