...
function ConvertToGIF({handleOptionSelect, handleSetFileData}) {
    ...
    fetch(
      `${BASE_URL}/api/convert-to-gif`,
      {
        ...
        body: JSON.stringify({
          ...
          convertEntireVideo: videoDuration > 6 ? false : true
        }),
        headers: {
  ...
  return (
    <div>
      <div className='convert-to-gif-title'>
      ...
      <div className='convert-to-gif-body'>
            ...
            <div className='note-section'>
              <span>*</span>
              <p>Videos having duration greater than 6s will be cut to 6s</p>
            </div>
